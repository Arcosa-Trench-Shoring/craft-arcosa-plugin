...
namespace arcosashoring\arcosa\widgets;

use arcosashoring\arcosa\Arcosa;
use arcosashoring\arcosa\assetbundles\arcosawidgetwidget\ArcosaWidgetWidgetAsset;
 ...
 * @since     1.0.0
 */
class ArcosaWidget extends Widget
{
    ...
    {
        return Craft::t('arcosa', 'ArcosaWidget');
    }
    ...
    {
        return Craft::getAlias("@arcosashoring/arcosa/assetbundles/arcosawidgetwidget/dist/img/ArcosaWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'arcosa/_components/widgets/ArcosaWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(ArcosaWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'arcosa/_components/widgets/ArcosaWidget_body',
            [
