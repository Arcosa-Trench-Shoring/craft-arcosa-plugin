...
class Install extends Migration
{
    ...
    // arcosa_arcosarecord table
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%arcosa_arcosarecord}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
                '{{%arcosa_arcosarecord}}',
    ...
    // arcosa_arcosarecord table
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%arcosa_arcosarecord}}', 'siteId'),
            '{{%arcosa_arcosarecord}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
    // arcosa_arcosarecord table
        $this->dropTableIfExists('{{%arcosa_arcosarecord}}');
    }
}
